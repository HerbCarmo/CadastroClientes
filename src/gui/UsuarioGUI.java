...
public void UsuarioDAO() {
    ...
    private void initComponents() {
        ...
        jToggleButton1.setText("Relatorio");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addGap(36, 36, 36)
                                .addComponent(txt_buscar, javax.swing.GroupLayout.PREFERRED_SIZE, 355, javax.swing.GroupLayout.PREFERRED_SIZE)
...
/*
SimpleDateFormat formato = new SimpleDateFormat("yyyy/MM/dd"); //DEFINE FORMATO DE DATA  
String data = formato.format(jDateChooser1.getDate()); //CONVERTE PRA STRING  
objUsuario.setData(data);
*/
    ...
    private void jToggleButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton1ActionPerformed
      ...
      Class.forName("com.mysql.jdbc.Driver");
       Connection con =     DriverManager.getConnection("jdbc:mysql://localhost:3306/db_usuario","root","");
       String reportPath = "C:\\Users\\Herbert\\Documents\\NetBeansProjects\\crud-java-se-com-mysql-master\\src\\gui\\simple.jrxml";
...
catch(Exception ex)
{
   ...
   objUsuario = new Usuario();
        ...
        // apaga os dados preenchidos nos campos de texto
        setClear();        // TODO add your handling code here:
